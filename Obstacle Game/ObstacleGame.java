...
public class ObstacleGame extends JPanel implements ActionListener, KeyListener {
    ...
    private Enemy[] enemies = new Enemy[10]; //the array of Enemy objects
    ...
    public void setUpGame() {
        ...
        enemies[0] = new SpinningEnemy(400, 400, 50, 50, 100);
        ...
        enemies[4] = new LandMine(250,250);
        enemies[5] = new LandMine(550,400);
        enemies[6] = new LandMine(100,450);
        enemies[7] = new LandMine(400,150);
        enemies[8] = new LandMine(400,400);
        enemies[9] = new LandMine(425,350);
    }
